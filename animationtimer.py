...
from PySide2 import QtWidgets, QtWidgets, QtCore, QtGui
...
class AnimationTimerUI(MayaQWidgetBaseMixin, QtWidgets.QMainWindow):
    """
    ...
    def create_actions(self):
        ...
        """
        # Action : New Timing
        self.action_new_timing = QtWidgets.QAction(u"New Timing", self)
        self.action_new_timing.setStatusTip(u"Create a new Timing")
        self.action_new_timing.setAutoRepeat(False)

        # Action : Open Timing
        self.action_open_timing = QtWidgets.QAction(u"Open Timing", self)
        ...
        self.submenu_recent_timing = QtWidgets.QMenu(u'Recent Timings', self)

        self.submenu_empty_action = QtWidgets.QAction(u'Empty', self)
        self.submenu_empty_action.setDisabled(True)

        # Action : Save
        self.action_save_timing = QtWidgets.QAction(u"Save", self)
        self.action_save_timing.setStatusTip(u"Save Timing")
        self.action_save_timing.setAutoRepeat(False)

        # Action : Save As...
        self.action_save_timing_as = QtWidgets.QAction(u"Save As ...", self)
        self.action_save_timing_as.setStatusTip(u"Save Timing as ...")
        self.action_save_timing_as.setAutoRepeat(False)

        # Action : Exit Program
        self.action_exit_app = QtWidgets.QAction(u"Exit", self)
        self.action_exit_app.setStatusTip(u"Close this script")

        # ---

        # Action : Discard current changes
        self.action_discard_current_changes = QtWidgets.QAction(u"Discard changes", self)
        ...
        self.action_reset_offsets = QtWidgets.QAction(u"Reset Offsets", self)
        ...
        self.action_preferences_window = QtWidgets.QAction(u"Preferences", self)
        self.action_preferences_window.setStatusTip(u"Open the preferences window")

        # ---

        # Action : Show on Maya TimeLine
        self.action_timing_on_timeline = QtWidgets.QAction(u"Show on Timeline", self)
        ...
        self.action_reset_window_size = QtWidgets.QAction(u"Reset window size", self)
        ...
        self.action_column_interval = QtWidgets.QAction(u"Show Interval Column", self)
        ...
        self.action_column_note = QtWidgets.QAction(u"Show Note Column", self)
        ...
        self.action_always_on_top = QtWidgets.QAction(u"Always on Top", self)
        ...
        self.action_open_docs = QtWidgets.QAction(u"Script on website", self)
        self.action_open_docs.setStatusTip(u"Open the script page inside a web browser")

        # Action : Feedback
        self.action_feedback_email = QtWidgets.QAction(u"Send a feedback", self)
        self.action_feedback_email.setStatusTip(u"Open your default mail client to send a feedback")

        # Action : Add to Shelf
        self.action_add_to_shelf = QtWidgets.QAction(u"Add to Shelf", self)
        self.action_add_to_shelf.setStatusTip(u"Add a shortcut to the selected shelf.")

        # Action : About Window
        self.action_about_window = QtWidgets.QAction(u"About", self)
    ...
    def create_controls(self):
        ...
        self.timer_label = QtWidgets.QLabel(u"00:00:000")
        ...
        self.timer_help = QtWidgets.QLabel(u"min : sec : millisec")
        ...
        self.fps_help = QtWidgets.QLabel(u"fps")
        ...
        # Frames
        self.frame_counter_label = QtWidgets.QLabel()
        self.frame_counter_label.setNum(0)

        self.frame_counter_help = QtWidgets.QLabel(u"frame")
        ...
        # File Info
        self.file_info_label = QtWidgets.QLabel(u"Untitled")
        ...
        # Buttons
        self.start_btn = QtWidgets.QPushButton(u"Start")
        ...
        self.stop_btn = QtWidgets.QPushButton(u"Stop")
    ...
    def create_layout(self):
        ...
        """
        # Timer Bar Layout
        timer_bar_layout = QtWidgets.QGridLayout()
        ...
        control_bar_layout = QtWidgets.QGridLayout()
    ...
    def on_new_file_action_triggered(self, force=False):
        ...
        if self.central_list.changed and not force:
            ...
            window = QtWidgets.QMessageBox.question(
                self,
            ...
            if window == QtWidgets.QMessageBox.Save:
...
class AnimationTimer(object):
    ...
    def on_open_docs_triggered(cls):
        ...
        return QtWidgets.QDesktopServices.openUrl(url)
...
class ATCenterList(QtWidgets.QTableWidget):
    """
    Center List object.
    """
    ...
    def __init__(self, parent):
        ...
        #This line cause - Fatall Error, u could try to fix this
    ...
    def add_row(self, time, frame, note):
        ...
        note_cell = QtWidgets.QTableWidgetItem(str(note))
...
class ATRecentTimings(object):
    ...
    def _generate_menu(self):
        ...
        if self.count > 0:
            ...
            for f in self.data:
                # Create QAction
                item = QtWidgets.QAction(f.fileName(), self.parent)
            ...
            item_clear = QtWidgets.QAction(u"Clear", self.parent)
...
class AnimationTimerOptions(QtWidgets.QDialog):
    ...
    def create_controls(self):
        ...
        # FPS
        self.fps_title = QtWidgets.QLabel(u"Frame per Second")
        self.fps_title.setFont(self.font)

        self.fps_radio_preset = QtWidgets.QRadioButton(u"Presets")
        self.fps_radio_preset.setFixedWidth(80)
        self.fps_radio_preset.setStyleSheet("""
                                        margin-left:15px;
                                        """)

        self.fps_radio_custom = QtWidgets.QRadioButton(u"Custom")
        self.fps_radio_custom.setFixedWidth(80)
        self.fps_radio_custom.setStyleSheet("""
                                        margin-left:15px;
                                        """)

        self.fps_combobox = QtWidgets.QComboBox()
        self.fps_combobox.setFixedWidth(100)

        self.fps_label = QtWidgets.QLabel(u"fps")
        self.custom_fps_label = QtWidgets.QLabel(u"fps")

        self.fps_custom_spinbox = QtWidgets.QSpinBox()
        ...
        # Offset Time
        self.offset_time_title = QtWidgets.QLabel(u"Offset Time")
        ...
        self.offset_time_eraser = QtWidgets.QPushButton()
    ...
    def create_layout(self):
        ...
        fps_custom_layout = QtWidgets.QHBoxLayout()
        ...
        # Offset Time
        offset_time_layout = QtWidgets.QHBoxLayout()
    ...
    def move_window(self):
        ...
        desk = QtWidgets.QDesktopWidget().screenGeometry()
...
class AnimationTimerPreferences(QtWidgets.QDialog):
    ...
    def _create_page_general(self):
        ...
        # Title Page
        self.title_general = QtWidgets.QLabel(u'General')
        self.title_general.setFont(self.section_font)
        self.title_general.setStyleSheet("margin-bottom:15px;")

        # Contents
        self.general_default_fps_label = QtWidgets.QLabel(u"Default FPS")
        self.general_default_fps_num = QtWidgets.QSpinBox()
        ...
        self.general_reset_offsets_on_new_file_checkbox = QtWidgets.QCheckBox()
        self.general_reset_offsets_on_new_file_label = QtWidgets.QLabel(u"Reset offsets on New File")

        self.general_auto_load_timing_checkbox = QtWidgets.QCheckBox()
        self.general_auto_load_timing_label = QtWidgets.QLabel(u"Open the last timing you worked on when script start")
    ...
    def _create_page_timings(self):
        ...
        # Title Page
        self.title_timings = QtWidgets.QLabel(u'Timings')
        self.title_timings.setFont(self.section_font)
        self.title_timings.setStyleSheet("margin-bottom:15px;")

        # Contents
        self.timings_default_dir_label = QtWidgets.QLabel(u"Default Directory")

        self.timings_default_dir_edit = QtWidgets.QLineEdit()
        self.timings_default_dir_edit.setReadOnly(True)

        self.timings_default_dir_btn = QtWidgets.QPushButton(u'...')
        self.timings_default_dir_btn.setFixedWidth(30)

        self.timings_default_dir_desc = QtWidgets.QLabel(
        ...
        self.timings_default_dir_hbox = QtWidgets.QHBoxLayout()
        ...
        self.timings_default_dir_sep = QtWidgets.QFrame()
        self.timings_default_dir_sep.setFrameShape(QtWidgets.QFrame.HLine)

        self.timings_dir_layout = QtWidgets.QVBoxLayout()
        ...
        self.timings_save_in_project_dir_checkbox = QtWidgets.QCheckBox()
        self.timings_save_in_project_dir_label = QtWidgets.QLabel(u"Save timings in projects directories")

        self.timings_recent_timing_label = QtWidgets.QLabel(u'timings in Recent Timings')
        self.timings_recent_timing_spinbox = QtWidgets.QSpinBox()
        ...
        self.timings_recent_timing_spinbox.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.timings_recent_timing_spinbox.setSingleStep(1)

        # Grid
        self.grid_timings = QtWidgets.QGridLayout()
        ...
        # Set layout
        self.layout_timings = QtWidgets.QVBoxLayout()
        ...
        # Set Widget Page
        self.page_timings = QtWidgets.QWidget()
